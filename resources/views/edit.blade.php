    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card mb-4 mb-xl-0">
                <div class="card-header"style="font-size:20px">Profile Picture</div>
                <div class="card-body text-center">
                    ...
                    {{-- <button class="btn btn-dark" type="Submit"style="font-size:20px;color:#eddcdc">Upload new image</button> --}}
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-4">
                <div class="card-header" style="font-size:20px;">Fill The Details</div>
                <div class="card-body">
                    <form method="post"action="adduser"name="myform"enctype="multipart/form-data">@csrf
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" id="mail" type="email"name="mail" placeholder="Enter your Email "style="font-size:20px;"value="{{old('mail')}}"readonly>
                        ...
                        <!-- Save changes button-->
                        <br><button class="btn btn-dark" type="submit"style="font-size:20px;"><a style="text-decoration:none;color:#eddcdc"name="btn"style="text-decoration:none;"name="btn">Add User</a></button>
                    </form>               
                </div>
            </div>
        </div>
