                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-5 col-12 me-auto mb-5">
                            <form class="custom-form filter-form" action="apply_filter_sofa" method="post" role="form">
                                @csrf
                                <div class="">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        <input name="price" type="radio" class="form-check-input" id="PriceCheckOne"
                                            value="10000">
                                    ...
                                    <div class="form-check">
                                        <input name="price" type="radio" class="form-check-input" id="PriceCheckTwo"
                                            value="20000">
                                    ...
                                    <div class="form-check">
                                        <input name="price" type="radio" class="form-check-input" id="PriceCheckThree"
                                            value="40000">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        <input name="type" type="radio" class="form-check-input" id="PriceCheckOne"
                                            value="2 seater">

                                        <label class="form-check-label" for="PriceCheckOne">2-Seater</label>
                                    </div>

                                    <div class="form-check">
                                        <input name="type" type="radio" class="form-check-input" id="PriceCheckTwo"
                                            value="3 seater">

                                        <label class="form-check-label" for="PriceCheckTwo">3-Seater</label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="PriceCheckTwo">4-Seater</label>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        <input name="color" type="radio" class="form-check-input" id="ConditionCheckOne"
                                            value="Gray">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        <input name="material" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="Fabric">
                                        <label class="form-check-label" for="ConditionCheckOne">Fabric</label>
                                    </div>

                                    <div class="form-check">
                                        <input name="material" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="Leather">
                                        <label class="form-check-label" for="ConditionCheckOne">Leather</label>
                                    </div>

                                    <div class="form-check">
                                        <input name="material" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="Metal">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        <input name="width" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="150">
                                        <label class="form-check-label" for="ConditionCheckOne">150-200 cm</label>
                                    </div>

                                    <div class="form-check">
                                        <input name="width" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="200">
                                        <label class="form-check-label" for="ConditionCheckOne">200-250 cm</label>
                                    </div>

                                    <div class="form-check">
                                        <input name="width" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="250">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        <input name="height" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="50">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        <input name="depth" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="75">
                                        <label class="form-check-label" for="ConditionCheckOne">75-100 cm</label>
                                    </div>

                                    <div class="form-check">
                                        <input name="depth" type="radio" class="form-check-input"
                                            id="ConditionCheckOne" value="100">
                                        <label class="form-check-label" for="ConditionCheckOne">100-150 cm</label>
                                    </div>
                                </div>

                                <div class="mt-4">
                                    <button type="submit" class="form-control btn btn-outline-info">Apple
                                        Filters</button>
                                </div>
                            </form>
                        </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="shop-thumb">
                                            <div class="shop-image-wrap">
                                                <a href="{{ URL::to('/user') }}/user_view_product/{{ $s['Pro_id'] }}">
                                                    <img src="{{ URL::to('/') }}/images/product/{{ $s['Pro_img'] }}"
                                                ...
                                                <p class="shop-pricing mb-0 mt-3">
                                                    <span class="badge custom-badge " style="position: absolute; top: 10px; left: 10px;  color: #af3918; padding: 5px; border-radius: 5px; font-size: 14px;">
                                                        @if ($offer->where('Pro_id', $s['Pro_id'])->count() > 0)
                                                        {{ $offer->where('Pro_id', $s['Pro_id'])->first()['Offer_percentage'] }}% OFF
                                                    @endif</span><br>
                                                </p>
                                                ...
                                                <div class="shop-icons-wrap">
                                                    <div class="shop-icons d-flex flex-column align-items-center">
                                                        ...
                                                        <a href="{{ URL::to('/user') }}/user_buy_now/{{ $s['Pro_id'] }}" class="shop-icon bi-shop"></a>
                                                        <a href="{{ URL::to('/user') }}/user_add_to_cart/{{ $s['Pro_id'] }}"
                                                            class="shop-icon bi-cart"></a>
                                                    </div>

                                                    @if ($offer->where('Pro_id', $s['Pro_id'])->count() > 0)
                            <p class="shop-pricing mb-0 mt-3">
                                <span class="badge custom-badge original-price">Rs. {{ $s['Pro_price'] }}</span><br>
                                <span class="badge custom-badge">Rs. {{ $offer->where('Pro_id', $s['Pro_id'])->first()['Offer_price'] }}</span>
                            </p>
                        @else
                            <p class="shop-pricing mb-0 mt-3">
                                <span class="badge custom-badge">Rs. {{ $s['Pro_price'] }}</span>
                            </p>
                        @endif
                                                </div>
