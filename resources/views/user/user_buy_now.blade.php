...
<html lang="en">
  ...
  <body style="background: rgb(161, 206, 220)">
    <form id="myForm" action="{{ URL::to('/user') }}/user_place_order/{{ $pro_detail['Pro_id'] }}" method="post">
      <h5 align = center class="text-info">Buy Now</h5>
        @csrf
      ...
      <div class="tab" id = "tab-1">
        ...
        {{-- <textarea name="address" id="" cols="30" rows="3" placeholder="Enter Address"></textarea> --}}
         <input type = "text" placeholder="Enter Address" name="address" value="{{ $loged_user['Address'] }}">
        <!-- <p>City:</p> -->
        <input type = "text" placeholder="Enter City Name" name="city" value="{{ $loged_user['City'] }}">
        <!-- <p>Pin:</p> -->
        <input type = "number" placeholder="Enter PinCode" name="pin" value="{{ $loged_user['Pin_code'] }}">
      ...
      <div class="tab" id = "tab-3">
        <p>Summary : </p>
        <div>
          <h6 class="shadow-sm p-3 mb-3 bg-body rounded"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
          <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
          </svg> Estimated Delivery in 6 Days.</h6>
        </div>
        <div class="row">
          <div class="col-4 col-sm-4 col-lg-4 col-md-4 col-xxl-4 col-xl-4 p-2">
            <img src="{{ URL::to('/') }}/images/product/{{ $pro_detail['Pro_img'] }}" class="img-fluid" style="height:150px;width:150px">
          </div>
          <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 p-2 mt-2">
            <h6 class="fs-lg-2 fs-sm-5">{{ $pro_detail['Pro_name'] }}</h6>
            @if ($offer->where('Pro_id', $pro_detail['Pro_id'])->count() > 0)
                            <p class="shop-pricing mb-0 mt-3">
                              <h3 class="fs-lg-2 fs-sm-5">Rs. {{ $offer->where('Pro_id', $pro_detail['Pro_id'])->first()['Offer_price'] }}</h3>
                              <h6 class="fs-lg-2 fs-sm-5"> {{ $offer->where('Pro_id', $pro_detail['Pro_id'])->first()['Offer_percentage'] }}% OFF</h6>
                            </p>
                        @else
                            <p class="shop-pricing mb-0 mt-3">
              ...
              <div class="col-4">
                <div class="row">
                  <div class="col-4">
                    <h6 class="mt-3">Qnt: </h6>
                  </div>
                  <div class="col-9 mt-0">
                    <input type="number" class="form-control form-control-sm" min="1" max="5" name="quantity" >
                  </div>
                </div>
              </div>
          </div>
