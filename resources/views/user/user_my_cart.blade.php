        ...
        <div class="cart-container">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><img src="{{ URL::to('/') }}/images/product/{{ $d->Pro_img }}" alt="" height="100px" width="100px"></td>
                    <td>{{ $d->Pro_name }}</td>
                    <td id="iprice">Rs.{{ $d->Pro_price }}</td>
                    <td class="item-quantity">
                        <a href="{{ URL::to('/user') }}/decrement_quantity/{{ $d->Pro_id }}"><button class="decrement btn btn-outline-dark">-</button></a>
                        <input class="quantity" type="text" value="{{ $d->Quantity }}" readonly>
                        <a href="{{ URL::to('/user') }}/increment_quantity/{{ $d->Pro_id }}"><button class="increment btn btn-outline-dark">+</button></a>
                    </td>
                    <?php
                    $totalperquantity=0;
                    ...
                    <td>
                        <a href="{{ URL::to('/user') }}/user_buy_now/{{ $d->Pro_id }}"><button class="remove btn btn-info">Buy now</button></a>
                        <a href="{{ URL::to('/user') }}/user_remove_from_cart/{{ $d->Pro_id }}"><button class="remove btn btn-danger">Remove</button></a>
                    </td>
