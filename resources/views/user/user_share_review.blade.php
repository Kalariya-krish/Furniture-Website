...
<body>
    ...
    <div class="col">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post"action="add_review"name="myform"enctype="multipart/form-data">@csrf
                        <!-- Form Group (username)-->
                        <div class="col-md-6">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="email"name="email" placeholder="Enter your Email "style="font-size:20px;"value="{{ session('email') }}" readonly>
